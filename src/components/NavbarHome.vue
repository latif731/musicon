...
<template>
    <div id="home_navbar" class="bg-nav p-3 flex items-center justify-between sticky top-0 z-50">
        ...
        <div>
            ...
            <input type="text" class=" w-[859px] outline-none pl-2  bg-[#21242E] rounded-[8px] text-white" placeholder="search">
        </div>
        <div class="flex gap-6">
            ...
            <div>
                ...
                <h3 class="text-email font-kontol font-[400]">pamungkaslatifbudi@gmail.com</h3>
            </div>
        </div>
    </div>
</template>