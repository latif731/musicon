...
import Sidebar from './SidebarTop.vue';
    ...
    <div>
        ...
        <div class="flex">
            <div class="fixed">
                ...
                <div class="border border-sidebar w-[291px] h-[1085px] bg-sidebar text-white pt-6 pl-5 pr-7">
                    <SidebarBottom/>
                </div>
            </div>
            <div class="ml-[291px] p-7 bg-layout w-[100%]">
                <slot></slot>
            </div>
            <Player/>
        </div>
